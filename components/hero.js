    ...
    <>
      <div className="overflow-hidden relative">
        <Container className="flex flex-wrap justify-center pt-32 pb-64 overflow-hidden relative">
          ...
          <div className="m-8 absolute -z-10  bottom-40 lg:-bottom-60 ">
            <Animate
              initial={{ opacity: 0, y: 100 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ motion: "easeIn", duration: 1 }}
            >
              <div className="radius-100 rounded-lg overflow-hidden border-4 border-gray-600 shadow shadow-gray-900/50">
                <Image
                  src={appImage}
                  width="900"
                  height="auto"
